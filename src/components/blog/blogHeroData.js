export function createBlogHeroData(allWorks, allPosts, directusToken) {
  return {
    ...
    industryIcons: {
      all: '<path d="M14 4.66667H10.6667V14.6667H14.6667V5.33333ZM12 10H13.3333V8.66667H12V10ZM12 12.6667H13.3333V11.3333H12V12.6667ZM12 7.33333H13.3333V6H12V7.33333Z" fill="currentColor"/>',
      ...
      Energy:
        '<path d="M6.5 0L2 6H5L4.5 12L9 6H6L6.5 0Z" fill="currentColor"/>',
      "Disaster Management":
      ...
      "AI and Data Services":
        '<path d="M11 4H9L8 0H4L3 4H1C0.734784 4 0.48043 4.10536 0.292893 4.29289C0.105357 4.48043 0 4.73478 0 5V11C0 11.2652 0.105357 11.5196 0.292893 11.7071C0.48043 11.8946 0.734784 12 1 12H11C11.2652 12 11.5196 11.8946 11.7071 11.7071C11.8946 11.5196 12 11.2652 12 11V5C12 4.73478 11.8946 4.48043 11.7071 4.29289C11.5196 4.10536 11.2652 4 11 4ZM5 1H7L7.78 4H4.22L5 1ZM11 11H1V5H11V11ZM6 6C5.60444 6 5.21776 6.1173 4.88886 6.33706C4.55996 6.55682 4.30362 6.86918 4.15224 7.23463C4.00087 7.60009 3.96126 8.00222 4.03843 8.39018C4.1156 8.77814 4.30608 9.13451 4.58579 9.41421C4.86549 9.69392 5.22186 9.8844 5.60982 9.96157C5.99778 10.0387 6.39991 9.99913 6.76537 9.84776C7.13082 9.69638 7.44318 9.44004 7.66294 9.11114C7.8827 8.78224 8 8.39556 8 8C8 7.46957 7.78929 6.96086 7.41421 6.58579C7.03914 6.21071 6.53043 6 6 6ZM6 9C5.80222 9 5.60888 8.94135 5.44443 8.83147C5.27998 8.72159 5.15181 8.56541 5.07612 8.38268C5.00043 8.19996 4.98063 7.99889 5.01921 7.80491C5.0578 7.61093 5.15304 7.43275 5.29289 7.29289C5.43275 7.15304 5.61093 7.0578 5.80491 7.01921C5.99889 6.98063 6.19996 7.00043 6.38268 7.07612C6.56541 7.15181 6.72159 7.27998 6.83147 7.44443C6.94135 7.60888 7 7.80222 7 8C7 8.26522 6.89464 8.51957 6.70711 8.70711C6.51957 8.89464 6.26522 9 6 9Z" fill="currentColor"/>',
      Agriculture:
        '<path d="M6 0C4 0 2 1 2 3C2 4 2 5 1 6C1 8 3 9 3 11V12H9V11C9 9 11 8 11 6C10 5 10 4 10 3C10 1 8 0 6 0ZM8 11H4V10H8V11ZM10 6C10 7.5 8.5 8.5 8 10H4C3.5 8.5 2 7.5 2 6C3 5 3 4 3 3C3 1.5 4.5 1 6 1C7.5 1 9 1.5 9 3C9 4 9 5 10 6Z" fill="currentColor"/>',
      Telecommunication:
        '<path d="M11 8H10V3C10 2.73478 9.89464 2.48043 9.70711 2.29289C9.51957 2.10536 9.26522 2 9 2H7V1C7 0.734784 6.89464 0.48043 6.70711 0.292893C6.51957 0.105357 6.26522 0 6 0C5.73478 0 5.48043 0.105357 5.29289 0.292893C5.10536 0.48043 5 0.734784 5 1V2H3C2.73478 2 2.48043 2.10536 2.29289 2.29289C2.10536 2.48043 2 2.73478 2 3V8H1C0.734784 8 0.48043 8.10536 0.292893 8.29289C0.105357 8.48043 0 8.73478 0 9V11C0 11.2652 0.105357 11.5196 0.292893 11.7071C0.48043 11.8946 0.734784 12 1 12H11C11.2652 12 11.5196 11.8946 11.7071 11.7071C11.8946 11.5196 12 11.2652 12 11V9C12 8.73478 11.8946 8.48043 11.7071 8.29289C11.5196 8.10536 11.2652 8 11 8ZM3 3H9V8H3V3ZM11 11H1V9H11V11Z" fill="currentColor"/>',
    },
